...
class DuelSuccessController extends SuccessController
{
        ...
        if ($msisdn && $success == '1') {
            try {
                ...
                if ($service) {
                    ...
                    Log::warning('Duel success page: Service not found', [
                        'msisdn'      => $msisdn,
                        'servicename' => $servicename,
                    ]);
                }
            } catch (\Exception $e) {
                Log::error('Duel success page error', [
                    'msisdn' => $msisdn,
                    'error'  => $e->getMessage(),

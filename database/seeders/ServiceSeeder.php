...
class ServiceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $services = [
//            [
//                'name' => 'otp-subscription',
//                'type' => 'dcb',
//                'merchant_name' => env('MERCHANT_NAME', 'MediaWorld'),
//                'display_name' => 'Media World DCB Service',
//                'description' => 'VMS-DCB Subscription API for pin code verification and subscription',
...
//            ],
//            [
//                'name' => 'he-subscription',
//                'type' => 'evina',
//                'merchant_name' => env('MERCHANT_NAME', 'MediaWorld'),
//                'display_name' => 'MWtest',
//                'description' => 'DCB service Header Enrichment support',
//                'api_username' => env('DCB_USERNAME', 'MWtest'),
//                'api_password' => env('DCB_PASSWORD', 'MWtest24'),
//                'sp_id' => env('DCB_SP_ID', '2'),
//                'service_id' => env('DCB_SERVICE_ID', '295'),
...
//            ],
            [
                ...
                'shortcode' => '4089',
                'is_smart' => true,
                'alphanumeric' => 'QuickFun',
                'sub_message' => 'QuickFun subscription - israa',
                'timeout' => 30,
                'settings' => [],
                'is_active' => true,
                'enable_evina_fraud' => false,
